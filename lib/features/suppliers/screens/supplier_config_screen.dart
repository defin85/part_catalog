...
class SupplierConfigScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<SupplierConfigScreen> createState() =>
      _SupplierConfigScreenState();
}
...
class _SupplierConfigScreenState extends ConsumerState<SupplierConfigScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    ref.listen(supplierConfigFormProvider(widget.supplierCode),
        (previous, next) {
      ...
      child: Scaffold(
        appBar: AppBar(
          title: Text(widget.supplierCode != null
              ? t.suppliers.config
                  .screenTitle(supplierName: widget.supplierCode!)
          ...
          child: ListView(
            ...
            children: [
              ...
              CustomTextFormField(
                ...
                key: const ValueKey('supplierConfig_displayName'),
              ...
              CustomTextFormField(
                ...
                key: const ValueKey('supplierConfig_baseUrl'),
                validator: (value) => value?.isEmpty ?? true
              ...
              if (widget.supplierCode == 'armtek') ...[
                  ...
                  children: [
                    Expanded(
                      child: ElevatedButton.icon(
                        key: const ValueKey('supplierConfig_loadVkorg'),
                        onPressed: formState.isLoadingVkorgList
                            ...
                            : () {
                                ...
                                ref
                                    .read(supplierConfigFormProvider(
                                            widget.supplierCode)
                                        .notifier)
                                    .loadVkorgList();
                              },
                ...
                if (formState.availableVkorgList.isNotEmpty)
                  DropdownButtonFormField<String>(
                    value: _vkorgController.text.isNotEmpty
                        ? _vkorgController.text
                        : null,
                    decoration: InputDecoration(
                    ...
                    onChanged: (value) {
                      if (value != null) {
                        ...
                        ref
                            .read(
                                supplierConfigFormProvider(widget.supplierCode)
                                    .notifier)
                            .selectVkorg(value);
                      }
                    },
                  ...
                  Column(
                    ...
                    children: [
                      CustomTextFormField(
                        ...
                        labelText: t.suppliers.config.vkorg,
                        key: const ValueKey('supplierConfig_vkorg'),
                        validator: (value) => value?.isEmpty ?? true
                            ? t.suppliers.config.vkorgRequired
                            : null,
                      ),
                      if (formState.availableVkorgList.isEmpty &&
                          !formState.isLoadingVkorgList)
                        Padding(
              ...
              CustomTextFormField(
                ...
                key: const ValueKey('supplierConfig_customerCode'),
              ...
              if (widget.supplierCode == 'armtek') ...[
                Row(
                  children: [
                    Expanded(
                      child: ElevatedButton.icon(
                        key: const ValueKey('supplierConfig_loadUserInfo'),
                ...
                Row(
                  children: [
                    Expanded(
                      child: ElevatedButton.icon(
                        key: const ValueKey('supplierConfig_loadBrands'),
                    ...
                    Expanded(
                      child: ElevatedButton.icon(
                        key: const ValueKey('supplierConfig_loadStores'),
                      ...
                      child: Column(
                        ...
                        children: [
                              ...
                              children: [
                                ...
                                Row(
                                  children: [
                                    ...
                                    Text(
                                        'Плательщики: ${formState.userInfo!.structure?.rgTab?.length ?? 0}'),
                                  ],
                                ),
                                ...
                                Row(
                                  children: [
                                    ...
                                    const SizedBox(width: 8),
                                    Text(
                                        'Бренды: ${formState.config?.businessConfig?.brandList?.length ?? 0}'),
                                  ],
                                ),
                                const SizedBox(height: 4),
                                Row(
                                  children: [
                                    ...
                                    const SizedBox(width: 8),
                                    Text(
                                        'Склады: ${formState.config?.businessConfig?.storeList?.length ?? 0}'),
                                  ],
                                ),
                              ],
                            ),
                          ...
                          if (formState.userInfo!.structure != null &&
                              formState
                                      .userInfo!.structure!.rgTab?.isNotEmpty ==
                                  true) ...[
                            Text(
                            ...
                            const SizedBox(height: 8),
                            ...formState.userInfo!.structure!.rgTab!
                                .take(3)
                                .map((customer) {
                              return Padding(
                            ...
                            if (formState.userInfo!.structure!.rgTab!.length >
                                3)
                              Text(
                          ...
                          SizedBox(
                            ...
                            child: ElevatedButton.icon(
                              onPressed: () =>
                                  _showDetailedSupplierInfo(context, formState),
                              icon: const Icon(Icons.info_outline),
                              label:
                                  const Text('Показать детальную информацию'),
                              style: ElevatedButton.styleFrom(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      Expanded(
                        child: ElevatedButton.icon(
                          key: const ValueKey('supplierConfig_testConnection'),
                          onPressed:
                              formState.isTesting ? null : _testConnection,
                      ...
                      Expanded(
                        child: ElevatedButton.icon(
                          key: const ValueKey('supplierConfig_save'),
      ...
      case AuthenticationType.basic:
        return [
          CustomTextFormField(
            ...
            key: const ValueKey('supplierConfig_username'),
            validator: (value) => value?.isEmpty ?? true
          ...
          TextFormField(
            ...
            obscureText: true,
            key: const ValueKey('supplierConfig_password'),
            validator: (value) => value?.isEmpty ?? true
      ...
      case AuthenticationType.apiKey:
        return [
          CustomTextFormField(
            ...
            key: const ValueKey('supplierConfig_apiKey'),
            validator: (value) => value?.isEmpty ?? true
            ...
            SnackBar(
              content: Row(
                children: [
                  ...
                  const SizedBox(width: 8),
                  Expanded(
                    child: Text(result.successMessage ??
  ...
  Future<void> _saveConfig() async {
    if (_formKey.currentState?.validate() ?? false) {
      ...
      if (success && mounted) {
        ...
        if (mounted) {
          final formState =
              ref.read(supplierConfigFormProvider(widget.supplierCode));
          if (formState.error != null) {
            ScaffoldMessenger.of(context).showSnackBar(
              SnackBar(
  ...
  void _showDetailedSupplierInfo(
      BuildContext context, SupplierConfigFormState formState) {
    if (widget.supplierCode == null) {
      ScaffoldMessenger.of(context).showSnackBar(
    ...
    print(
        'UserInfo structure exists: ${formState.userInfo?.structure != null}');
    print(
        'UserInfo structure type: ${formState.userInfo?.structure.runtimeType}');
    ...
    if (!hasUserInfo && !hasBrandList && !hasStoreList) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text(
              'Нет данных для отображения. Сначала загрузите информацию о пользователе, бренды или склады.'),
    ...
    final supplierData = <String, dynamic>{
      ...
      'structure':
          formState.userInfo?.structure ?? const UserStructureRoot(rgTab: []),
    ...
    print(
        'Structure rgTab length: ${formState.userInfo?.structure?.rgTab?.length ?? 0}');
