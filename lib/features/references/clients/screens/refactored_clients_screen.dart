...
/// Рефакторенный экран клиентов с использованием новой UI системы
///
/// Ключевые улучшения:
...
class RefactoredClientsScreen extends ConsumerStatefulWidget {
  const RefactoredClientsScreen({super.key});

  @override
  ConsumerState<RefactoredClientsScreen> createState() => _RefactoredClientsScreenState();
}

class _RefactoredClientsScreenState extends ConsumerState<RefactoredClientsScreen> {
