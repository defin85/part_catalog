...
class ErrorHandler {
  ...
  static Future<T> executeWithLogging<T>({
    ...
    try {
      ...
      stopwatch.stop();
      logger.i('✅ Completed $operationName in ${stopwatch.elapsedMilliseconds}ms');
  ...
  static Future<Map<String, dynamic>> executeBatch({
    ...
    logger.i('🚀 Starting batch execution with ${operations.length} operations');
    ...
    logger.i('✅ Batch execution completed: $successCount/${operations.length} succeeded');
