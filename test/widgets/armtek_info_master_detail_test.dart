...
void main() {
  group('ArmtekInfoMasterDetail Widget Tests', () {
    ...
    final testStructure = const UserStructureRoot(
      kunag: '12345',
      vkorg: '4000',
      sname: 'Test Company',
    ...
    testWidgets('Should not have render overflow errors',
    ...
    testWidgets('Should detect Row overflow in compact cards at narrow widths',
      ...
      await tester.binding
          .setSurfaceSize(const Size(320, 600)); // Очень узкий экран
    ...
    testWidgets('Widget tests can detect overflow on very narrow screens',
      ...
      final problematicStructure = const UserStructureRoot(
        kunag: '12345',
        vkorg: '4000',
        sname: 'Very Long Company Name That Might Cause Overflow Issues',
        fname:
            'Extremely Long Full Company Name That Definitely Will Cause Overflow',
